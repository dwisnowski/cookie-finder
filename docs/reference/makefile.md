...
| `make on-the-pi-cloudflare-tunnel-start` / `make cloudflare-tunnel-start` | Pi | Start `cloudflared.service` |
| `make on-the-pi-cloudflare-tunnel-stop` / `make cloudflare-tunnel-stop` | Pi | Stop `cloudflared.service` |
